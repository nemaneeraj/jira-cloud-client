...
import com.atlassian.jira.rest.client.model.ProjectComponent;
...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2021-03-17T19:36:29.866+05:30[Asia/Kolkata]")@Component("com.atlassian.jira.rest.client.api.ProjectComponentsApi")
public class ProjectComponentsApi {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public List<ProjectComponent> getProjectComponents(String projectIdOrKey) throws RestClientException {
        Object postBody = null;
