...
import com.atlassian.jira.rest.client.model.StringList;
...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2021-03-17T19:36:29.866+05:30[Asia/Kolkata]")@Component("com.atlassian.jira.rest.client.api.ProjectsApi")
public class ProjectsApi {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public PageBeanProject searchProjects(Long startAt, Integer maxResults, String orderBy, String query, String typeKey, Long categoryId, String action, String expand, List<String> status, List<StringList> properties, String propertyQuery) throws RestClientException {
        Object postBody = null;
