...
public class ComponentWithIssueCount {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(issueCount, description, lead, assigneeType, self, project, assignee, projectId, realAssignee, isAssigneeTypeValid, realAssigneeType, name, id);
  }
